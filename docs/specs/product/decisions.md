...
| 2026-08-26 | Barre d'outils native possédée par le layout, alimentée par les plugins (agents à gauche, Run à droite) | Tout au clavier/palette ; boutons dans les panneaux | Les actions les plus fréquentes méritent un clic ; une seule surface, déclarative |
