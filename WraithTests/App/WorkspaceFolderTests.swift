...
struct WorkspaceFolderTests {
    ...
    private let currentDirectory = URL(filePath: "/Users/tester/code/wraith", directoryHint: .isDirectory)
    ...
    @Test func resolvesRelativePathAgainstCurrentDirectory() {
        #expect(resolve("docs") == folder("/Users/tester/code/wraith/docs"))
    ...
    @Test func readsTheFolderArgumentAndIgnoresFlags() {
        #expect(WorkspaceFolder.argument(in: ["/Applications/Wraith.app/Contents/MacOS/Wraith"]) == nil)
        #expect(WorkspaceFolder.argument(in: ["Wraith", "-NSDocumentRevisionsDebugMode", "YES"]) == nil)
        #expect(WorkspaceFolder.argument(in: ["Wraith", "/Users/tester/code"]) == "/Users/tester/code")
        #expect(WorkspaceFolder.argument(in: ["Wraith", "-psn_0_1", "~/code"]) == "~/code")
        #expect(WorkspaceFolder.argument(in: ["Wraith", "."]) == ".")
    }
