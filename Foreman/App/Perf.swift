...
///
/// `workspace.open`: the request (`ForemanAppDelegate`) to the zones' first frame. `panel.show`:
...
nonisolated enum Perf {
    static let signposter = OSSignposter(subsystem: "dev.crafters.foreman", category: "perf")
}
