...
final class EditorFeature {
    ...
    /// overwriting, an IO error is shown. Only the prompts need a window: a dirty tab whose view
    /// is detached is still written, and stays dirty when a prompt cannot be shown.
