...
| M18 — LSP: diagnostics, hover, go-to-definition | [m18-lsp.md](m18-lsp.md) | editor ([`03-study-lsp.md`](../specs/editor/03-study-lsp.md) R35–R46, [`04-study-selectors.md`](../specs/editor/04-study-selectors.md) R47–R49) | 🟢 (2026-08-31; asked by the testers, completion excluded on purpose; closed after a round of fixes driven by use — the banner now quotes the server, an entry carries its `cwd`, and four questions stay open in `questions.md`) |
